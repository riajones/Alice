...
public class AGraphics{
	...
	void draw_eye(Graphics g){
		...
		int circle_x = (int)(eye_x * 0.6);
		int circle_y = (int)(eye_y * 0.6);
		...
		g.fillOval((int)(eye_x * 0.2), (y_size/2 - circle_y/2), circle_x, circle_y);
		g.setColor(Color.WHITE);
		g.fillOval((int)(eye_x * 0.2) + outline_x/2, (y_size/2 - circle_y/2) + outline_y/2, circle_x - outline_x, circle_y - outline_y);
		g.setColor(Color.BLUE);
		g.fillOval((int)(eye_x * 0.2) + c_x/2, (y_size/2 - circle_y/2) + c_y/2, circle_x - c_x, circle_y - c_y);
		g.setColor(Color.BLACK);
		g.fillOval((int)(eye_x * 0.2) + pupil_x/2, (y_size/2 - circle_y/2) + pupil_y/2, circle_x - pupil_x, circle_y - pupil_y);
	}
